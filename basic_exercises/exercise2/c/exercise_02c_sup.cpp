...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < image1.rows; i++)
    {
        ...
        {
            image1.at<uchar>(i, j) = std::max(image1.at<uchar>(i, j), image2.at<uchar>(i, j));
        }
    }

    uint outputFilenameLength = strlen("exercise_02c_sup_output_01.pgm") + 1;
    ...
    uint winNameLength = strlen("Window: supremum of the images") + 1;
